...
- UI 类修改用页面捕获直接捕获真实渲染 + 视觉分析验证；服务端类修改用临时端口验证服务
...
- UI changes are verified with real rendered-page capture + vision analysis; server changes with a preview server on a temporary port
