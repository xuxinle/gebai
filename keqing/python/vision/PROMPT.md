...
- 模型资产复用歌白 CV 约定：GEBAI_CV_MODELS_DIR（det.onnx/rec.onnx/dict.txt 的 PP-OCR 三件套，源码形态在 packages/server/assets/cv-models/）与 GEBAI_CV_DETECT_MODEL（或 {GEBAI_HOME}/models/detect/ 唯一 .onnx）。
