 ...
 * bun build/--compile 无法内联；二进制形态下以 gzip base64 内嵌进产物，运行时释放到
 * `{GEBAI_HOME}/resources/vendor/cv/`（内嵌 ort 运行时同目录；资源布局见
 * packages/agents/src/core/cv/resources.ts）。服务端 dist
