...
export type ToolContext = {
   ...
   */
  cron?: {
    add: (input: import("../schedule/cron").CronCreateInput, originSessionId?: string) => Promise<import("../schedule/cron").CronTask>
    list: () => Promise<import("../schedule/cron").CronTask[]>
    remove: (id: string) => Promise<boolean>
    update: (id: string, patch: import("../schedule/cron").CronUpdateInput) => Promise<import("../schedule/cron").CronTask | null>
    trigger: (id: string) => Promise<import("../schedule/cron").CronTask | null>
  }
}
