  ...
  return {
    ...
    items: {
      ...
      properties: {
        ...
        target: { type: "string", description: "webhook=URL；feishu=群机器人 webhook URL 或群 chat_id（oc_ 前缀，应用身份推送指定群）；feishu_chat=群 chat_id；webhook 用 webhookId 引用时可省略" },
