...
export const description =
  "小学（1-6 年级）全科学习辅导：具象化引导解题（实物类比/画图/生活情境，小步引导逐级放手）、口算与应用题训练、看图写话与阅读理解、错题本（自动 1/3/7/14/30 天间隔复习）与知识点掌握度评估（按用户持久保存）、学习习惯培养与家长陪学建议。小学生本人或家长（低年级常由家长代述）的学习辅导需求装载本子Agent（中学辅导用 tutor_secondary）。输入：问题/题目/学习需求；输出：具象化引导讲解、趣味练习与批改、掌握度与错题管理。"
