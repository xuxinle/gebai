...
export const DEMO_TEMPLATES: DemoTemplate[] = [
  ...
  },
  {
    id: "reference",
    usage:
      '内置公式与定理速查库（静态知识、零 token 展示）：{ subject? 学科（数学/物理/化学/英语）, topic? 主题或名称子串（如 圆、浮力、方程式、时态）, id? 单条 }——不传 = 索引目录页；传过滤 = 该范围速查卡（公式大字+要点易错，部分定理带图示与证明思路）；讲公式/定理/给学生做速查表时用。覆盖 82 条（与 Web 空白页知识快捷入口一一对应）：小学数学（平面/立体图形、运算律与简算、分数与小数、竖式计算、单位换算、行程/工程/鸡兔同笼植树、统计与平均数）；数学（乘法公式、因式分解、二次根式、分式、一元二次方程、锐角三角函数、全等相似、勾股/内角和、圆周角与切线、函数、三角恒等与图象、解三角形、数列、不等式、导数、直线与圆、圆锥曲线、立体几何、排列组合、概率分布）；物理（力与运动、牛顿定律与受力、光与声、热学与物态变化、压强、浮力、功和能、简单机械、电学、圆周与万有引力、电场电路、磁场与安培/洛伦兹力）；化学（金属活动性、酸碱盐、常考方程式、溶液与溶解度、物质的量与浓度、有机官能团与反应、守恒定律）；英语（五大时态表）',
    render: reference,
  },
]
